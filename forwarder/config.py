...
class Development(Config):
    ...
    FROM_CHATS = [-1001241675729,-1001881627229,-1001860656056,-1001877280212,-1001502705198,-1001749139811,-1001688333632]# List of chat id's to forward messages from.
